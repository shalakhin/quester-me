...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('defaults_userposition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('address', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quest.Address'], null=True, blank=True)),
            ('point', self.gf('django.contrib.gis.db.models.fields.PointField')()),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('defaults', ['UserPosition'])


    def backwards(self, orm):
        # Deleting model 'UserPosition'
        db.delete_table('defaults_userposition')
