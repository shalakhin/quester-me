...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field quests on 'Profile'
        db.create_table('profiles_profile_quests', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm['profiles.profile'], null=False)),
            ('quest', models.ForeignKey(orm['quest.quest'], null=False))
        ))
        db.create_unique('profiles_profile_quests', ['profile_id', 'quest_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field quests on 'Profile'
        db.delete_table('profiles_profile_quests')
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quests': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'quests'", 'null': 'True', 'to': "orm['quest.Quest']"}),
